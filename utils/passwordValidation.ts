/**
 * Regras de validação de senha — política única compartilhada por todos os fluxos.
...
/**
 * Valida a senha conforme a política padrão do TCS.
 * Retorna { valido: true } se aprovada ou { valido: false, erro: mensagem } caso contrário.
 */
...
export const FORCA_LABELS: ['Fraca', 'Média', 'Forte'] = ['Fraca', 'Média', 'Forte'];
export const FORCA_CORES: [string, string, string] = ['#EF4444', '#F59E0B', '#10B981'];
