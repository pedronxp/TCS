...
export function PortalAgendaPage() {
  ...
  return (
    <div className="page-stack">
      ...
      {agenda.isError && <p className="rounded-md border border-destructive/20 bg-destructive-soft p-4 text-sm text-destructive" role="alert">Não foi possível carregar a agenda.</p>}
