...
const states: PortalState[] = [
  ...
  },
  {
    id: 'dashboard-empty',
    path: '/portal/individual',
    expectedText: 'Nenhuma vistoria encontrada neste escopo.',
    options: { emptyDashboard: true },
  },
  {
    id: 'dashboard-error',
    path: '/portal/individual',
    expectedText: 'Não foi possível carregar o painel.',
  ...
  },
  {
    ...
    expectedText: 'Recurso disponível em outro plano',
    options: { accessOverrides: { features: { reports: false } } },
  },
  {
    id: 'portal-access-unavailable',
    path: '/portal/individual',
    expectedText: 'Acesso em preparação',
  ...
  },
  {
    ...
    expectedText: 'Este convite não está disponível.',
    authenticated: false,
  ...
  },
  {
    ...
    expectedText: 'Confirmando pagamento',
    options: { checkoutStatus: 'pending' },
  },
  {
    id: 'checkout-failed',
    path: `/checkout/retorno?checkout=${checkoutId}`,
    expectedText: 'Não foi possível consultar o checkout',
    options: { checkoutStatus: 'failed' },
  },
  {
    id: 'checkout-expired',
    path: `/checkout/retorno?checkout=${checkoutId}`,
    expectedText: 'Checkout expirado',
...
const asyncRoutes: AsyncRouteState[] = [
  {
    ...
    errorText: 'Não foi possível carregar o painel.',
    emptyText: 'Nenhuma vistoria encontrada neste escopo.',
  ...
  ...[
    ...
    ['individual-relatorios', '/portal/individual/relatorios', 'relatorios'],
    ...
    ['municipal-relatorios', '/portal/municipal/relatorios', 'relatorios'],
  ...
  ...[
    ...
    emptyText: 'Nenhum ponto disponível.',
  ...
  ...[
    ...
    kind: id.startsWith('municipal-') ? 'organization' as const : 'individual' as const,
    loadingText: 'Carregando sessões',
    errorText: 'Não foi possível carregar as sessões.',
    emptyText: 'Nenhuma sessão registrada.',
  ...
  ...[
    ...
    kind: id.startsWith('municipal-') ? 'organization' as const : 'individual' as const,
    loadingSelector: 'main .animate-pulse',
    errorText: 'Vistoria não encontrada',
  })),
];
