...
const routes: InternalRoute[] = [
  { id: 'dashboard-owner', path: '/app', heading: 'Visão executiva do negócio', role: 'owner' },
  { id: 'customers', path: '/app/clientes', heading: 'Clientes', role: 'owner' },
  { id: 'customer-detail', path: '/app/clientes/organization%3Aaurora/resumo', heading: 'Prefeitura de Aurora', role: 'owner' },
  { id: 'customer-appointments', path: '/app/clientes/organization%3Aaurora/agendamentos', heading: 'Prefeitura de Aurora', role: 'owner' },
  { id: 'customer-map', path: '/app/clientes/organization%3Aaurora/mapa', heading: 'Prefeitura de Aurora', role: 'owner' },
  { id: 'customer-documents', path: '/app/clientes/organization%3Aaurora/laudos', heading: 'Prefeitura de Aurora', role: 'owner' },
  { id: 'agent-detail', path: '/app/clientes/organization%3Aaurora/usuarios/agent-7/resumo', heading: 'Marina Alves', role: 'owner' },
  ...
  { id: 'staff', path: '/app/staff', heading: 'Equipe interna', role: 'owner' },
  { id: 'audit', path: '/app/auditoria', heading: 'Auditoria', role: 'owner' },
  { id: 'configuration', path: '/app/governanca/configuracoes', heading: 'Configurações', role: 'owner' },
  ...
  { id: 'dashboard-developer', path: '/app', heading: 'Painel de desenvolvimento', role: 'developer' },
