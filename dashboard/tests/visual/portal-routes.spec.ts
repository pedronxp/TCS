...
const routes: PortalRoute[] = [
  { id: 'public-plans', path: '/planos', heading: 'Um plano para cada escala de operação.', kind: 'individual', authenticated: false },
  { id: 'portal-login', path: '/entrar', heading: 'Entrar no portal', kind: 'individual', authenticated: false },
  { id: 'portal-sign-up', path: '/criar-conta', heading: 'Criar conta individual', kind: 'individual', authenticated: false },
  { id: 'portal-invite-acceptance', path: `/convite/${'a'.repeat(48)}`, heading: 'Convite para o portal municipal', kind: 'organization', authenticated: false },
  { id: 'portal-checkout-return', path: '/checkout/retorno?checkout=65000000-0000-4000-8000-000000000001', heading: 'Assinatura confirmada', kind: 'individual' },
  ...
  { id: 'portal-individual-mapa', path: '/portal/individual/mapa', heading: 'Mapa', kind: 'individual' },
  ...
  { id: 'portal-individual-relatorios', path: '/portal/individual/relatorios', heading: 'Relatórios', kind: 'individual' },
  ...
  { id: 'portal-municipal-dashboard', path: '/portal/municipal', heading: 'Olá, Marina', kind: 'organization' },
  ...
  { id: 'portal-municipal-mapa', path: '/portal/municipal/mapa', heading: 'Mapa', kind: 'organization' },
  ...
  { id: 'portal-municipal-relatorios', path: '/portal/municipal/relatorios', heading: 'Relatórios', kind: 'organization' },
