...
export const routeManifest = [
  ...
  ...[
    ...
    ['mensagens', 'profile.read', 'listing'],
  ...
  portalRoute({
    id: 'portal-municipal-whatsapp',
    path: '/portal/municipal/whatsapp',
    audience: ['coordinator', 'supervisor', 'agent'],
  ...
  route({
    id: 'protocol-inspection-detail',
    path: '/app/protocolos/:inspectionId',
    audience: ['owner', 'developer', 'support', 'auditor'],
    permission: 'protocol.read',
    template: 'context-detail',
    penpot: '35 · Registro de protocolos',
  ...
  route({
    id: 'protocol-document-laudo',
    path: '/app/protocolos/:inspectionId/laudo',
    audience: ['owner', 'developer', 'support', 'auditor'],
    permission: 'protocol.read',
    template: 'context-detail',
    penpot: '35 · Registro de protocolos',
  ...
  route({
    id: 'protocol-document-relatorio',
    path: '/app/protocolos/:inspectionId/relatorio',
    audience: ['owner', 'developer', 'support', 'auditor'],
    permission: 'protocol.read',
    template: 'editor',
    penpot: '35 · Registro de protocolos',
  ...
  route({
    id: 'protocol-document-termo',
    path: '/app/protocolos/:inspectionId/termo',
    audience: ['owner', 'developer', 'support', 'auditor'],
    permission: 'protocol.read',
    template: 'editor',
    penpot: '35 · Registro de protocolos',
  ...
  route({
    id: 'protocol-document-fotos',
    path: '/app/protocolos/:inspectionId/fotos',
    audience: ['owner', 'developer', 'support', 'auditor'],
    permission: 'protocol.read',
    template: 'context-detail',
    penpot: '35 · Registro de protocolos',
  ...
  route({
    ...
    automatedVisualBaselines: null,
    approvalStatus: 'approved-in-penpot',
    visualSource: 'Penpot/TCS — Web Dashboard/11 · Sessões',
  }),
  route({
    id: 'support',
    path: '/app/suporte',
  ...
  route({
    id: 'operational-statistics',
    path: '/app/operacao/estatisticas',
    audience: ['owner', 'developer'],
    permission: 'technical.read',
    template: 'dashboard',
    penpot: '24 · Dashboard técnico',
    approvalStatus: 'approved-in-penpot',
    visualSource: 'Penpot/TCS — Web Dashboard/24 · Dashboard técnico',
    automatedVisualBaselines: null,
  }),
  route({
  ...
  route({
    id: 'console-comunicados-org',
    path: '/app/comunicacoes/:orgId',
    audience: ['owner', 'developer'],
    permission: 'communication.manage',
    template: 'context-detail',
    penpot: '12 · Equipe interna',
  ...
  route({
    id: 'console-whatsapp-org',
    path: '/app/whatsapp/:orgId',
    audience: ['owner', 'developer'],
    permission: 'whatsapp.read',
    template: 'context-detail',
    penpot: '12 · Equipe interna',
  ...
  route({
    id: 'console-whatsapp-communities',
    path: '/app/whatsapp/:orgId/comunidades',
    audience: ['owner', 'developer'],
    permission: 'whatsapp.read',
    template: 'settings',
    penpot: '12 · Equipe interna',
  ...
  route({
    id: 'form-preview',
    path: '/app/desenvolvimento/formularios/:formId',
    audience: ['developer'],
    permission: 'technical.read',
    template: 'context-detail',
    penpot: '16 · Formulários',
    automatedVisualBaselines: null,
    approvalStatus: 'approved-in-penpot',
    visualSource: 'Penpot/TCS — Web Dashboard/16 · Formulários',
  }),
  route({
    id: 'risk-rules',
