...
// O captcha foi removido do app: a proteção Turnstile segue apenas no painel web
// (dashboard via VITE_TURNSTILE_SITE_KEY). Sem EXPO_PUBLIC_TURNSTILE_SITE_KEY o
// app não exibe o desafio e não envia captchaToken.
