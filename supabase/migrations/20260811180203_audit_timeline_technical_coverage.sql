-- Expands the internal audit read model with sanitized technical telemetry.
-- The source tables remain append-only; this only changes the staff-facing projection.
