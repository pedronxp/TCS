...
User asks about networking
  ...
  |   \-- Expo Router loaders — see native-data-fetching-expo-router-loaders.md
  |
  |-- Basic fetch?
...
-> See native-data-fetching-expo-router-loaders.md for route-level loaders (web, SDK 55+). For native, use React Query or fetch.
