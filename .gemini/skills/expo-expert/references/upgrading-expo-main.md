...
- upgrading-expo-new-architecture.md -- SDK +53: New Architecture migration guide
- upgrading-expo-react-19.md -- SDK +54: React 19 changes (useContext → use, Context.Provider → Context, forwardRef removal)
- upgrading-expo-react-compiler.md -- SDK +54: React Compiler setup and migration guide
- upgrading-expo-native-tabs.md -- SDK +55: Native tabs changes (Icon/Label/Badge now accessed via NativeTabs.Trigger.\*)
- upgrading-expo-expo-av-to-audio.md -- Migrate audio playback and recording from expo-av to expo-audio
- upgrading-expo-expo-av-to-video.md -- Migrate video playback from expo-av to expo-video
